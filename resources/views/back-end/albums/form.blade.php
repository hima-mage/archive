...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="col-md-7"><label class="outborder">{{ $album_number !="" ? $album_number->id+1 : 1 }}</label></div>
    </div>
    <div class="col-md-4">
...
<div class="row">
    <div class="col-md-6">
        <div class="col-md-3"><label>اسم الألبوم</label></div>
        <div class="col-md-9">
    ...
    <div class="col-md-4">
         <div class="col-md-5"><label>تاريخ  الفعالية </label> </div>
        <div class="col-md-7"> 
...
<div class="row">
    <div class="col-md-6">
        <div class="col-md-3"><label>المكان/الموقع/البلد</label></div>
            <div class="col-md-9">
                @php $input = "location"; @endphp
                <select  name="{{ $input }}" id="{{ $input }}" class="form-control" >
                <option value=""></option>
                <option value="1" {{ isset($row) && $row->location == "1" ? "selected" : "" }} >Value 1</option>
                <option value="2" {{ isset($row) && $row->location == "2" ? "selected" : "" }}>Value 2</option>
            </select>
                <span class="{{ $input.'_error' }} invalid-feedback" role="alert"></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="col-md-3"><label>المدرسة</label></div>
            <div class="col-md-9">
                @php $input = "school"; @endphp
                <select  name="{{ $input }}" id="{{ $input }}" class="form-control" >
                <option value=""></option>
                <option value="1" {{ isset($row) && $row->school == "1" ? "selected" : "" }} >Value 1</option>
                <option value="2" {{ isset($row) && $row->school == "2" ? "selected" : "" }}>Value 2</option>
            </select>
                <span class="{{ $input.'_error' }} invalid-feedback" role="alert"></span>
        </div>
    </div>
